...
const games = {}; // Stores active game states and timers
...
io.on('connection', (socket) => {
    ...
    if (!waitingPlayer) {
        ...
        // Initialize 5+0 game state (300 seconds per player)
        games[roomId] = {
            white: opponent.id,
            black: socket.id,
        ...
        // Notify players and assign colors
    ...
    // Pass WebRTC Signaling messages between peers
    ...
    socket.on('make_move', (data) => {
        ...
        // Switch turns
        game.turn = data.nextTurn; // Trusted client evaluation synchronized here
        
        socket.to(roomId).emit('move_received', move);
    });

    // Handle Timeouts or Game Overs
    ...
    socket.on('disconnect', () => {
        ...
        // Find if user was in an active game
